...
contract ElasticV2 is Test {
  ...
  address wmaticUsdtPool = 0xcFCabDE33784334BB735D12CDD427166dA9F5187;
  IERC721 nft = IERC721(0x27f993271a4D38Ada6DBE9845050f916a09Bd1aE);
  ...
  function setUp() public virtual {
    ...
    ranges.push(IKSElasticLMV2.RangeInput({tickLower: -290000, tickUpper: -260000, weight: 1}));
  ...
  function testDeposit() public {
    ...
    assertEq(farmingTokenBalance, _getLiq(nftId));
  ...
  function testClaimReward() public {
    ...
    assertEq(knc.balanceOf(jensen), rewardAmount / 3);
  }
  ...
  function testAddLiquidity() public {
    ...
    assertEq(lastSumRewardPerLiquidity[0], 398245571496762089144905921);
  }
  ...
  function testRemoveLiquidity() public {
    ...
    assertEq(farmingTokenBalance, 0);
  ...
  function testClaimFee() public {
    ...
    assertEq(balanceAfter - balanceBefore, 174254303886356);
  }
}
