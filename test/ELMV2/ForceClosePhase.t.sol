...
contract ForceClosePhase is Base {
  ...
  function testForceClosePhaseSuccessDeposited() public {
    ...
    assertEq(sumRewardPerLiquidity[0], 138_939_511_855_686_960_426_433_007); // calculate by rewardAmount * joinedDuration(86399) * 2^96 / duration(2630000) / totalLiq(18733193066)
