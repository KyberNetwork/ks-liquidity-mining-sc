...
contract RemoveLiquidity is Base {
  ...
  function _calculateRewardAmount(
    ...
    rewardAmount = (joinedDuration * liquidity * farmReward) / (duration * totalLiquidity);
  }
  ...
  function testRemoveAllLiquidityThenWithdrawEmergencyWhenNotEmergencyEnabled() public {
    uint256 nftId = nftIds[2];
  ...
  function testRemoveAllLiquidityThenWithdrawEmergencyWhenEmergencyEnabled() public {
    uint256 nftId = nftIds[2];
  ...
  function testRemoveAllLiquidityThenAddLiquidityWithElasticV2() public {
    (, , MockNftManager mockNft, MockPool mockPool) = _mockElasticV2TestSetup();
    ...
    (IBasePositionManager.Position memory pos, ) = IBasePositionManager(address(mockNft))
      .positions(nftId);
